...
class DifftestInterfaces extends Module {
  ...
  val int_writeback = DifftestModule(new DiffIntWriteback, dontCare = true)
  val fp_writeback = DifftestModule(new DiffFpWriteback, dontCare = true)
  val vec_writeback = DifftestModule(new DiffVecWriteback, dontCare = true)
  val vec_v0_writeback = DifftestModule(new DiffVecV0Writeback, dontCare = true)
